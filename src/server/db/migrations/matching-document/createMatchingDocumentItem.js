...
module.exports = function(queryInterface) {
  return queryInterface.createTable('MatchingDocumentItem', {
    id: {
    ...
    return Promise.all([
      queryInterface.addIndex(
        ...
        ['MatchingDocumentSN'],
        { indexName: 'MatchDoctItem_MatchingDocumentSN_idx' }
      ),
      queryInterface.addIndex(
        'MatchingDocumentItem',
        ['SupplierID'],
        { indexName: 'MatchDoctItem_SupplierID_idx' }
      ),
      queryInterface.addIndex(
        'MatchingDocumentItem',
        ['ProductID'],
        { indexName: 'MatchDoctItem_ProductID_idx' }
      ),
      queryInterface.addIndex(
        'MatchingDocumentItem',
        ['TaxID'],
        { indexName: 'MatchDoctItem_TaxID_idx' }
      )
    ])
  });
};
